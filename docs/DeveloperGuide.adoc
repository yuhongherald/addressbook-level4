...
* Figure 12 below shows the process of initializing ImportSession.
+
.Sequence Diagram of `ImportSession` initialization
image::SessionInitializationSequenceDiagram.png[width="800"]

* Figure 13 below shows the process of reviewing job entries in an import session.
+
...
Persistent Data
addJobs/addEmployee method location
ImportSession data extraction
JobEntry
