...
2.  ServicingManager shows logged remarks in the job.
3.  User requests to log a remark.
4.  ServicingManager reflects the added remark at end of log.
+
Use case ends.
...
+
[none]
** 2a1. ServicingManager shows an empty list.
+
...
3.  ServicingManager completes the command.
+
Use case ends.
...
2.  ServicingManager changes selection.
+
Use case ends.
...
[none]
* 1a. ServicingManager is not focussed.
+
[none]
...
2.  ServicingManager adds the employee and updates the list.
+
Use case ends.
...
2.  ServicingManager shows a list of employees.
3.  User requests to delete a specific employee in the list.
4.  ServicingManager deletes the employee and updates the list.
+
Use case ends.
...
+
[none]
** 3a1. ServicingManager shows an error message.
+
...
2.  ServicingManager shows a list of employees whose name contain the provided name.
+
Use case ends.
...
2.  ServicingManager updates the label colors displayed.
+
Use case ends.
...
+
[none]
** 1a1. ServicingManager shows an error message.
+
Use case ends.
...
+
[none]
** 1b1. ServicingManager shows an error message.
+
Use case ends.
