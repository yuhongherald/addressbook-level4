...
As the user continues to use the program, more commands are added into the `undoStack`. For example, shown in the figure below, the user may execute `add n/David ...` to add a new employee.
