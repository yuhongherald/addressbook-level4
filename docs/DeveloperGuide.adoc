...
|`* * *` |user |delete an ongoing job entry |remove unwanted ongoing job
...
|`* * *` |user |add remarks to an ongoing job entry |take not of details that are specific to the job
...
|`* * *` |user |view all employees | decide who to assign to a job entry
...
|`* *` |user |view employee's schedule on calender |
|=======================================================================
