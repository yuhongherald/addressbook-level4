= Car Servicing Manager - Developer Guide
:toc:
:toc-title:
...
:repoURL: https://github.com/CS2103JAN2018-W09-B1/addressbook-level4/tree/master
...
|`* * *` |user |redo my commands |redo undo commands
...
(For all use cases below, the *System* is the `CarServicingManager` and the *Actor* is the `user`, unless specified otherwise)
...
2.  CarServicingManager shows logged remarks in the job.
3.  User requests to log a remark.
4.  CarServicingManager reflects the added remark at end of log.
+
Use case ends.
...
+
[none]
** 2a1. CarServicingManager shows an empty list.
+
...
3.  CarServicingManager completes the command.
+
Use case ends.
...
2.  CarServicingManager changes selection.
+
Use case ends.
...
[none]
* 1a. CarServicingManager is not focussed.
+
[none]
...
2.  CarServicingManager adds the employee and updates the list.
+
Use case ends.
...
+
[none]
** 2a1. CarServicingManager shows an error message.
+
Use case resumes at step 1.
...
2.  CarServicingManager shows a list of employees.
3.  User requests to delete a specific employee in the list.
4.  CarServicingManager deletes the employee and updates the list.
+
Use case ends.
...
+
[none]
** 3a1. CarServicingManager shows an error message.
+
...
2.  CarServicingManager shows a list of employees whose name contain the provided name.
+
Use case ends.
...
2.  CarServicingManager updates the label colors displayed.
+
Use case ends.
...
+
[none]
** 1a1. CarServicingManager shows an error message.
+
Use case ends.
...
+
[none]
** 1b1. CarServicingManager shows an error message.
+
Use case ends.
...
4.  CarServicingManager adds the job entry.
+
Use case ends.
...
+
[none]
** 3b1. CarServicingManager shows an error message.
+
Use case resumes at step 3.
+
Use case ends.
...
2.  CarServicingManager shows a list of job entries.
3.  User requests to close a specific job entry in the list.
4.  CarServicingManager close the job entry.
+
Use case ends.
