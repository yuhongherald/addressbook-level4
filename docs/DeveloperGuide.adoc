...
Please http://www.oracle.com/technetwork/java/javase/downloads/jdk8-downloads-2133151.html[update your JDK] if your version is earlier than the stated.
+
...
* **Alternative:** `ModelManager` and member variables gets access and provides API to access `CommandWords`.
...
1.  Add a shorthand equivalent alias for each of the individual commands. For example, besides typing `clear`, the user can also type `c` to remove all employees in the list.
+
[NOTE]
* Hints
