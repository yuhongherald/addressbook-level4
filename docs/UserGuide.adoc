...
To accept a job with job number `NUMBER` in the imported list, you can use this command.
...
To reject a job with job number `NUMBER` in the imported list, you can use this command.
