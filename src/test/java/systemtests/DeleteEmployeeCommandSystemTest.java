...
public class DeleteEmployeeCommandSystemTest extends AddressBookSystemTest {
    ...
    /**
     * Deletes the person at {@code toDelete} by creating a default {@code DeleteEmployeeCommand} using {@code toDelete} and
    ...
    private void assertCommandSuccess(Index toDelete) {
        ...
        assertCommandSuccess(
                DeleteEmployeeCommand.COMMAND_WORD + " " + toDelete.getOneBased(), expectedModel, expectedResultMessage);
    }
