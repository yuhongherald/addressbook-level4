...
import static seedu.address.logic.commands.DeleteEmployeeCommand.MESSAGE_DELETE_PERSON_SUCCESS;
...
public class DeleteEmployeeCommandSystemTest extends AddressBookSystemTest {
    ...
    public void delete() {
        ...
        assertCommandFailure(
                DeleteEmployeeCommand.COMMAND_WORD + " abc", MESSAGE_INVALID_DELETE_COMMAND_FORMAT);

        /* Case: invalid arguments (extra argument) -> rejected */
        assertCommandFailure(
                DeleteEmployeeCommand.COMMAND_WORD + " 1 abc", MESSAGE_INVALID_DELETE_COMMAND_FORMAT);
    ...
    /**
     * Deletes the person at {@code toDelete} by creating a default {@code DeleteEmployeeCommand} using {@code toDelete}
    ...
    private void assertCommandSuccess(Index toDelete) {
        ...
        assertCommandSuccess(
                DeleteEmployeeCommand.COMMAND_WORD + " " + toDelete.getOneBased(), expectedModel,
