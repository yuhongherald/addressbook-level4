...
public class XmlAdaptedEmployeeTest {
    ...
    public void toModelType_nullName_throwsIllegalValueException() {
        XmlAdaptedEmployee person = new XmlAdaptedEmployee(null, VALID_PHONE, VALID_EMAIL, VALID_ADDRESS, VALID_TAGS);
    ...
    public void toModelType_nullPhone_throwsIllegalValueException() {
        XmlAdaptedEmployee person = new XmlAdaptedEmployee(VALID_NAME, null, VALID_EMAIL, VALID_ADDRESS, VALID_TAGS);
    ...
    public void toModelType_nullEmail_throwsIllegalValueException() {
        XmlAdaptedEmployee person = new XmlAdaptedEmployee(VALID_NAME, VALID_PHONE, null, VALID_ADDRESS, VALID_TAGS);
    ...
    public void toModelType_nullAddress_throwsIllegalValueException() {
        XmlAdaptedEmployee person = new XmlAdaptedEmployee(VALID_NAME, VALID_PHONE, VALID_EMAIL, null, VALID_TAGS);
