...
import seedu.servicing.model.person.NameContainsKeywordsPredicate;
...
public class CommandTestUtil {
     ...
     * - the servicing book and the filtered person list in the {@code actualModel} remain unchanged
     */
    ...
    /**
     * Deletes the first person in {@code model}'s filtered list from {@code model}'s servicing book.
     */
