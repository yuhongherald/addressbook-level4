...
public class RejectCommandTest extends ImportCommandTestEnv {
    ...
    public void equals() throws Exception {
        ...
        RejectCommand acceptCommand2 = prepareCommand(2, comment);
        RejectCommand acceptCommand3 = prepareCommand(1, "");
        ...
        assertFalse(rejectCommand1.equals(acceptCommand2));

        // different comments -> return false
        assertFalse(rejectCommand1.equals(acceptCommand3));
